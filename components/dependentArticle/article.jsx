...
const Article = ({Img}) => {
    return (
        <article className="w-[11rem] items-center flex flex-col px-2 py-2 overflow-hidden rounded-lg shadow-[0px_0px_4px_#a3a3a3] hover:shadow-[0px_1px_10px_rgba(0,0,0,0.5)] transition-all">
