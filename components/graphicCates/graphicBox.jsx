...
const GraphicBox = () => {
    return (
        <Link href={'/'} className="flex justify-between rounded-lg GraphicCategories mb-10 bg-gray-200 px-3 py-3 transition-all duration-300 hover:bg-[#d3d7ff] hover:text-gray-50 hover:shadow-[0px_0px_10px_rgba(0,0,0,0.25)]">
